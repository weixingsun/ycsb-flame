...
<title>Uses of Class com.datastax.driver.core.querybuilder.Select.Builder (DataStax Java Driver for Apache Cassandra - Binary distribution 3.0.0 API)</title>
...
<script type="text/javascript"><!--
    try {
        if (location.href.indexOf('is-external=true') == -1) {
            parent.document.title="Uses of Class com.datastax.driver.core.querybuilder.Select.Builder (DataStax Java Driver for Apache Cassandra - Binary distribution 3.0.0 API)";
        }
    }
    catch(err) {
    }
...
<td class="colLast"><span class="typeNameLabel">Select.SelectionOrAlias.</span><code><span class="memberNameLink"><a href="../../../../../../com/datastax/driver/core/querybuilder/Select.SelectionOrAlias.html#all--">all</a></span>()</code>
<div class="block">Selects all columns (i.e.</div>
</td>
</tr>
<tr class="altColor">
...
<tr class="rowColor">
<td class="colFirst"><code><a href="../../../../../../com/datastax/driver/core/querybuilder/Select.Builder.html" title="class in com.datastax.driver.core.querybuilder">Select.Builder</a></code></td>
<td class="colLast"><span class="typeNameLabel">Select.SelectionOrAlias.</span><code><span class="memberNameLink"><a href="../../../../../../com/datastax/driver/core/querybuilder/Select.SelectionOrAlias.html#countAll--">countAll</a></span>()</code>
<div class="block">Selects the count of all returned rows (i.e.</div>
</td>
</tr>
<tr class="altColor">
